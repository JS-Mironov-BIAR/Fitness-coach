...
const GROUPS: { title: string; items: string[] }[] = [
  {
    ...
    items: [
      "Админка: липкий хедер с иконками; кнопка «Сайт»; выход — в подвале с подтверждением.",
      "Карточка заявки: липкая навигация Заявка · Промт · Анкета.",
      "Календарь-обзор в расписании — наглядно видно занятые и свободные дни.",
      "Стильные кастомные выпадающие списки и чекбоксы в формах.",
      "Плавающее меню «Разделы» в анкете, соцсети отдельной строкой в шапке, мобильные правки.",
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      "Лента Instagram на главной — живые посты вместо сухого «обо мне».",
  ...
  {
    title: "Юридическое и публикация",
    items: [
      "Политика обработки данных и условия использования (ссылки в подвале).",
      "Согласие на обработку данных в анкете и форме записи.",
      "Фавикон halvafit, красивое превью ссылок (OG), брендовая страница 404.",
      "Защита базы от засыпания (ежедневный авто-пинг).",
    ],
  },
];
